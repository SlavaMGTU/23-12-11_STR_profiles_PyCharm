...
from determination_of_relationship import det_relationship
...
app.layout = html.Div([
    ...
    html.Button('Определение родства', id='relation_button', n_clicks=0),  # Добавляем кнопку "Определение родства"
    ...
    if n_clicks > 0:
        ...
        if contents is not None:
            ...
            if df is None:
                ...
                nl = '\n'
                answ = f'ИТОГИ: <br> {det_relationship(child_value, parent1_value, parent2_value, df)}'
                return answ
...
#pyinstaller --onedir 2024-05-13exe.py
