...
def search_for_parents_all(df, child_row_gl, parent1_gl, parent2_gl):# MARKBOOK!!!! ЗАКЛАДКА
...
def update_result(df, n_clicks, child_value, parent1_value, parent2_value):
    if n_clicks > 0:
        ...
        result = search_for_parents_all(df,child_value, parent1_value, parent2_value)
        return result
