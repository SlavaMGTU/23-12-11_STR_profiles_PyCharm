#06/01/2024 все данные на сами себя проверка всех со всеми на поиск родственников
import pandas as pd
import re
...
def search_for_parents(child_row, parent1, parent2, numb_col):
    ...
    return answ
df = pd.read_csv('D:\\work\\23-12-11_STR_profiles_PyCharm\\STR профили для программы3.csv'
        ...
        for parent2 in df['id_f']:
            if child != parent1 and child != parent2:
                if  parent1 != parent2:
                    ...
                    if  parent1_index_gl >= 16 and parent2_index_gl >= 16 :
...
df_relativ.to_csv('file_all.csv')