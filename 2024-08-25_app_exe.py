...
from determ_of_relation_1Horse2024_06_22 import det_of_relation_1Horse_app
    ...
    if n_clicks > 0:
        if contents is not None:
            ...
            if df is None:
                ...
                # Удаление строки
                #df_table = df_table[df_table['Имя'] != child_value]
...
#pyinstaller --onedir 2024-08-25_app_exe.py
